...
It also features a radio button where the user can detail which club their query is about.  It is not required that the user use these as there query may be a general query.  It is planned that the query can be directed to a specific person within the club depending on what radio button is selected.

The form finishes with a ‘submit query’ button.
...
## Consistent Features.
Each page has a responsive Navigation bar with five links justified to the right to link to each of the five pages.  A logo is present in the top left that links to the home page.  A footer is present on every page with social media icons linking to the Facebook, twitter, Instagram and YouTube.
...
# Testing.
## User Stories – Website UX and link test.
...
2. I want to be able to easily navigate the site on any platform
...
3. I want to know what Wing Chun is
	* *The ‘about’ page has sections that describe ‘What Wing Chun is’ and the ‘History of Wing Chun’*
	* *The user can navigate to these from the ‘about’ link in the top nav menu on each page.  This takes the user to the ‘about’ page where there are media boxes that link to relevant sections further down in the page, or the user can scroll down to the required section.*
...
4. I want to get an idea about what it would be like to train at West Midlands Wing Chun Kuen
    * *The ‘about’ page has a section that details the club which includes the club history, The journey Sifu (teacher) has taken and the club ethos.*
	* *The ‘classes’ page has a section that details ‘What to expect’ from the clubs.*
...
7. I want to know, as a new student, what is the cost of training and are there any payment options
    ...
    * *The ‘schedule & prices’ section on the classes’ page can be accessed from the media box link in the discovery section on the landing page.*
8. I want to be able to contact the club to ask any questions that I may have about a specific club location if required.
...
9. It would be good to be able to easily check out the clubs presence on social media to give me a further idea as to who trains there 
