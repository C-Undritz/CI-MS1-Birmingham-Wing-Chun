...
* *Fixed by: iplementing the two points raised above: each image contained within row/col and styled each image as 100% width*
3. Carousel banner on the classes page not filling the container at tablet and mobile resolutions.  I could not get the BS carousel to fill the 